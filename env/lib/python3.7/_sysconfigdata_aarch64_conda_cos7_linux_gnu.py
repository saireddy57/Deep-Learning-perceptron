...
build_time_vars = {'ABIFLAGS': 'm',
 ...
 'BLDSHARED': 'aarch64-conda_cos7-linux-gnu-gcc -pthread -shared -Wl,-O2 '
              ...
              '-Wl,-rpath,/config/workspace/perceptron/env/lib '
 ...
 'CONFIGURE_LDFLAGS': '-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro '
                      ...
                      '-Wl,-rpath,/config/workspace/perceptron/env/lib '
                      '-L/config/workspace/perceptron/env/lib',
 'CONFIG_ARGS': "'--prefix=/config/workspace/perceptron/env' "
                ...
                "-I/config/workspace/perceptron/env/include' "
                "'CPP=/config/workspace/perceptron/env/bin/aarch64-conda_cos7-linux-gnu-cpp' "
 ...
 'LIBFFI_INCLUDEDIR': '/config/workspace/perceptron/env/include',
 'LIBM': '-lm',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/config/workspace/perceptron/env/lib/pkgconfig',
 'LIBPL':
     '/config/workspace/perceptron/env/lib/python3.7/config-3.7m-aarch64-linux-gnu',
 ...
 'OPENSSL_INCLUDES': '-I/config/workspace/perceptron/env/include',
 'OPENSSL_LDFLAGS': '-L/config/workspace/perceptron/env/lib',
