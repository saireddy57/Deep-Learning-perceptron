...
build_time_vars = {'ABIFLAGS': 'm',
 ...
 'CONFIG_ARGS': "'--prefix=/config/workspace/perceptron/env' "
                ...
                "-I/config/workspace/perceptron/env/include' "
                "'CPP=/config/workspace/perceptron/env/bin/powerpc64le-conda_cos7-linux-gnu-cpp' "
 ...
 'LIBPL': '/config/workspace/perceptron/env/lib/python3.7/config-3.7m-powerpc64le-linux-gnu',
